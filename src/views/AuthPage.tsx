...
export function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-950">
      {/* Left panel */}
      <div className="hidden w-[480px] shrink-0 flex-col justify-between bg-gradient-to-b from-indigo-600 to-violet-700 p-12 lg:flex">
        <div className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/20">
            <ShoppingBag size={15} className="text-white" />
          </div>
          <span className="text-sm font-bold text-white">OrderHub</span>
        </div>
        <div>
        ...
        <p className="text-xs text-indigo-300">© 2025 OrderHub</p>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <button
            ...
            disabled={loading}
            className="mt-8 flex w-full items-center justify-center gap-3 rounded-xl border border-slate-700 bg-slate-800 py-2.5 text-sm font-medium text-slate-200
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white
                           placeholder:text-slate-600 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20"
              />
            </div>
            <div>
